A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Last Contact State
...
`Note:` The remote module for creating a Genesys Cloud data actions integration can be found [here](https://github.com/GenesysCloudDevOps/public-api-get-last-contact-state-data-action-module "Opens github.com/GenesysCloudDevOps/public-api-get-last-contact-state-data-action-module")
